            ...
            <div class="card-body loginpage">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/signIn">
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-info btn-md btn-login btn-block text-uppercase waves-effect waves-light" type="submit">Admin Log In</button>
                        </div>
                    </div>
                </form>
            </div>
                    <div class="form-group text-center m-t-40">
                        <div class="col-xs-12">
                            <a href="<?php echo base_url() ?>Counter" class="btn btn-info btn-md btn-login btn-block text-uppercase waves-effect waves-light">SALES COUNTER</a>
                        </div>
                    </div>            
        </div>
    </section>
