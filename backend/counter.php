        ...
        <div class="login-box card">
            <div class="card-body loginpage">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="counter/signIn">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <select name="counter" class="form-control" id="" required="1">
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-info btn-md btn-login btn-block text-uppercase waves-effect waves-light" type="submit">Useer Log In</button>
                        </div>
                    </div>
                </form>
            </div>
            <div class="form-group text-center m-t-40">
                        <div class="col-xs-12">
                            <a href="./" class="btn btn-info btn-md btn-login btn-block text-uppercase waves-effect waves-light">ADMIN LOGIN</a>
                        </div>
                    </div>  
        </div>
    </section>
