                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control mrp" name="mrp" id="mrp" placeholder="Amount" readonly tabindex="-1" value="">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="input-group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <div class="row form-group">
                            <div class="col-md-5">
                              <label for="example-text-input" class=" col-form-label pos-label">Total KES.
                              </label>
                            </div>
                            <div class="col-md-7">
                          ...
                          <div class="row form-group">
                            <div class="col-md-5">
                              <label for="example-text-input" class=" col-form-label pos-label">Payable KES.
                              </label>
                            </div>
                            <div class="col-md-7">
                          ...
                          <div class="row form-group">
                            <div class="col-md-5">
                              <label for="example-text-input" class=" col-form-label pos-label">Paid KES.
                              </label>
                            </div>
                            <div class="col-md-7">
                          ...
                          <div class="row form-group">
                            <div class="col-md-5">
                              <label for="example-text-input" class=" col-form-label pos-label">Return KES.
                              </label>
                            </div>
                            <div class="col-md-7">
                          ...
                          <div class="row form-group">
                            <div class="col-md-5">
                              <label for="example-text-input" class=" col-form-label pos-label">Due KES.
                              </label>
                            </div>
                            <div class="col-md-7">
