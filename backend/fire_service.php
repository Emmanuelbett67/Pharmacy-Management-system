...
<?php  $this->load->view('backend/sidebar');?>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item ">Fire Service</li>
                    </ol>
                </div>
            </div>
            <!-- Container fluid  -->
            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="#" class="text-white"  data-toggle="modal" data-target=".bs-example-modal-lg"><i class="" aria-hidden="true"></i> Add Fire Service</a></button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ">
                                    <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                           <?php foreach($fire_service as $value): ?>
                                            <tr>
        ...
        <script>
             $("#submit").on("click", function(event) {
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>help/add_fire_service",
                    type: "POST",
                    dataType: 'json',
                    data: {
                        'name': $('#name').val(),
