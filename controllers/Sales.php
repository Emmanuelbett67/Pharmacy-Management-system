...
echo " <div class='card-body pos_receipt'>
        ...
        foreach($invoice_details as $value):
            ...
            <td style='right;font-size: 12px;font-weight: 600;color: #000'>";echo $id; echo"</td>
              ...
              <td style='right;font-size: 12px;font-weight: 600;color: #000'>$value->total_price Kes.</td>              
            </tr>";
          ...
          echo "</tbody>
            ...
            <td></td>
              ...
              <td style='right;font-size: 12px;font-weight: 600;color: #000'> $invoice->due_amount Kes.</td>
            </tr>
            <tr>
            <td></td>
            <td></td>
              <td colspan='1' style='right;font-size: 12px;font-weight: 600;color: #000'>Paid</td>
              <td style='right;font-size: 12px;font-weight: 600;color: #000'>$invoice->paid_amount Kes.</td>
            </tr>
            <tr>
            <td></td>
            <td></td>
              <td colspan='1' style='right;font-size: 12px;font-weight: 600;color: #000'>Total Amount</td>
              <td style='right;font-size: 12px;font-weight: 600;color: #000'>$invoice->total_amount Kes.</td>
            </tr>
          </table>
        </div>
