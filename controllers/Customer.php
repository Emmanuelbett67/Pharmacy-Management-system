...
/*        echo date('F Y',strtotime('-1 month')).' : '.$total.' '."Target:".$targetbalance->target_amount.'   '."Discount:".$targetbalance->target_discount.'%';*/
                              echo"<div class='dues'>";
            if($dues->total_due > 0){ 
                                  echo"<h4 class='previous-due-header'><span class='previous-dues'>Previous Dues= </span> $dues->total_due KES</h4>";
            }
                              echo"</div>
                               <div class='borderc'>
                                   <h5 class='discount-info'><span>";echo date('F Y').' : '. "</span>$total KES</h5>
                                   <h5 class='discount-info'><span>Target Amount:</span>$targetbalance->target_amount KES</h5>
