...
echo " <div class='card-body pos_receipt'>
        ...
        foreach($_POST['qty'] as $row=>$name):
            ...
            <td style='right;font-size: 12px;font-weight: 600;color: #000'>";echo $id; echo"</td>
              ...
              <td style='right;font-size: 12px;font-weight: 600;color: #000'>$total KES.</td>              
            </tr>";
                }
                endforeach;
          echo "</tbody></table>
          ...
          <table style='font-size:8px'>
            <tr>
              <td colspan='9'></td>
              <td style='right;font-size: 12px;font-weight: 600;color: #000'>Net Due: $duea KES.</td>
            </tr>
            <tr>
            <td></td>
            <td></td>
              <td colspan='7'></td>
              <td style='right;font-size: 12px;font-weight: 600;color: #000'>Paid: $paid KES.</td>
            </tr>
            <tr>
                <td colspan='9'></td>
              <td style='right;font-size: 12px;font-weight: 600;color: #000'>Change: $change KES.</td>
            </tr>
          </table>
        </div>
